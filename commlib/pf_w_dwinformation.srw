HA$PBExportHeader$pf_w_dwinformation.srw
forward
...
// $$HEX11$$44c5dcad3cbab8d22000c0bc18c220006cad58d530ae$$ENDHEX$$
...
// $$HEX13$$44c5dcad3cbab8d22000c0bc18c2200011c9f5bc20001cc870ac$$ENDHEX$$
...
// $$HEX18$$c0d085c7d0c5200030b578b9200044c5dcad3cbab8d2200030aef8bc12ac200024c115c8$$ENDHEX$$
for i = 1 to ll_argcnt
	...
	if ll_find > 0 then
		...
		choose case lower(ls_argtype)
			...
			case 'decimal array', 'decimallist'
				ls_repstr = "( 0.0 )"
			case else
				messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$(of_setdatainfo)', '$$HEX19$$44c5dcad3cbab8d22000c0d085c744c7200055d678c760d5200018c22000c6c5b5c2c8b2e4b2$$ENDHEX$$')
				return -1
		end choose
	end if
...
if len(ls_error) > 0 then
	::clipboard(ls_select)
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$(Data)', ls_error)
	return -1
end if
