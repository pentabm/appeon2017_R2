HA$PBExportHeader$pf_u_mdi_iconmenu.sru
$PBExportComments$MDI$$HEX41$$54d674ba200004c7d0c52000acc0a9c690c758c720008cad5cd5d0c5200030b57cb7200054ba74b27cb920005cd4dcc274d52000fcc894b22000acc0a9c690c7200024c60cbe1dc8b8d2200085c7c8b2e4b2$$ENDHEX$$.
forward
...
for i = 1 to ll_rowcnt
	...
	gnv_extfunc.pf_gettextsizeW(handle(this), ls_pgm_name, "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$", 10, 700, lstr_textsize)
	ll_textwidth = pixelstounits(lstr_textsize.width, xpixelstounits!) + ll_intergap
	
	//$$HEX12$$44c574c758cf85ba74c72000c6c544c718c2c4b388c7e4b2$$ENDHEX$$. By KYJ 2013.08.28
	...
	ll_xpos += 82
	lnv_buffer.of_append('create text(band=header alignment="2" text="' + ls_pgm_name + '" border="0" color="7829367" x="' + string(ll_xpos) + '" y="36" height="76" width="' + string(ll_textwidth) + '"  html.valueishtml="0"  name=t_menu_' + string(i, '00') + ' tag="' + ls_menu_id + '" pointer="HyperLink!" visible="1"  font.face="$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$" font.height="-10" font.weight="700"  font.family="1" font.pitch="2" font.charset="1" background.mode="2" background.color="553648127" )')
...
// program full path $$HEX3$$9ccd25b8a9c6$$ENDHEX$$
...
event pfe_postopen;call super::pfe_postopen;// $$HEX12$$54ba74b28cad5cd5200024c60cbe1dc8b8d22000ddc031c1$$ENDHEX$$
inv_rolemenu = create pf_n_rolemenu

// TOP$$HEX5$$54ba74b220006cad04d6$$ENDHEX$$
//this.of_drawtopmenu()
