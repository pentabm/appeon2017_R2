HA$PBExportHeader$pf_n_regexp.sru
$PBExportComments$$$HEX23$$15c8dcad5cd404d6ddc2200030aea5b244c72000c0c9d0c658d594b2200024c60cbe1dc8b8d2200085c7c8b2e4b2$$ENDHEX$$.
forward
...
public function boolean of_validate_ishangul (string as_value);/************************************************
DESCRIPTION: $$HEX19$$5cd500ae74c72000ecd368d51cb4200038bb90c7f4c578c7c0c9200055d678c769d5c8b2e4b2$$ENDHEX$$
...
iole_regexp.Pattern = "[$$HEX1$$3131$$ENDHEX$$-$$HEX1$$4e31$$ENDHEX$$|$$HEX1$$4f31$$ENDHEX$$-$$HEX1$$6331$$ENDHEX$$|$$HEX1$$00ac$$ENDHEX$$-$$HEX1$$a3d7$$ENDHEX$$]"

// $$HEX29$$5cd500ae5cb8ccb920006cad31c11cb4200038bb90c7f4c544c7200055d678c760d52000bdacb0c6200044c598b7200028d334d12000acc0a9c6$$ENDHEX$$
//iole_regexp.Pattern = "^[$$HEX1$$3131$$ENDHEX$$-$$HEX1$$4e31$$ENDHEX$$|$$HEX1$$4f31$$ENDHEX$$-$$HEX1$$6331$$ENDHEX$$|$$HEX1$$00ac$$ENDHEX$$-$$HEX1$$a3d7$$ENDHEX$$]+$"
...
public function boolean of_validate_phonenumber (string as_value);/************************************************
DESCRIPTION: $$HEX14$$04c854d688bc38d6200028d334d144c7200044be50ad69d5c8b2e4b2$$ENDHEX$$
...
// (02) 769-9795 $$HEX11$$15d6dcd058c7200004c854d688bc38d6200028d334d1$$ENDHEX$$
iole_regexp.Pattern = "^\(\d{2,3}\)\s?\d{3,4}-\d{4}$"

// 02-769-9795 $$HEX12$$15d6dcd058c7200004c854d6200088bc38d6200028d334d1$$ENDHEX$$
...
public function boolean of_validate_email (string as_value);/************************************************
DESCRIPTION: E-Mail $$HEX9$$28d334d144c7200055d678c769d5c8b2e4b2$$ENDHEX$$
...
public function boolean of_validate_url (string as_value);/************************************************
DESCRIPTION: URL $$HEX9$$28d334d144c7200044be50ad69d5c8b2e4b2$$ENDHEX$$
...
public function string of_replace (string as_searchstr, string as_pattern, string as_newstr);///************************************************
//DESCRIPTION: $$HEX21$$7cc758ce58d594b2200028d334d144c7200080acc9c0c4d6200074d5f9b2200038bb90c7f4c544c72000$$ENDHEX$$Replace $$HEX3$$69d5c8b2e4b2$$ENDHEX$$
//
// PARAMETERS:
...
//
//RETURNS:
//   $$HEX7$$58ce58d61cb4200038bb90c7f4c5$$ENDHEX$$
//
//REMARKS: New String $$HEX22$$40c7200044c598b740c6200019ac40c7200015d6dcd05cb82000acc0a9c6200000aca5b2200069d5c8b2e4b2$$ENDHEX$$.
//  "($1) $2-$3"
//*************************************************/
string ls_result
...
public function string of_replaceall (string as_searchstr, string as_pattern, string as_newstr);///************************************************
//DESCRIPTION: $$HEX27$$7cc758ce58d594b2200028d334d144c72000a8ba50b4200080acc9c0c4d6200074d5f9b2200038bb90c7f4c544c72000a8ba50b42000$$ENDHEX$$Replace $$HEX3$$69d5c8b2e4b2$$ENDHEX$$
//
// PARAMETERS:
//   as_searchstr - String to be tested for validity
//   as_pattern - Search pattern
...
public function integer of_findmatches (string as_searchstr, string as_pattern, ref string as_result[]);///************************************************
//DESCRIPTION: $$HEX26$$7cc758ce58d594b2200028d334d144c7200080acc9c0c4d6200074d5f9b2200038bb90c7f4c544c720006cad74d535c6c8b2e4b2$$ENDHEX$$.
//
// PARAMETERS:
...
//
//RETURNS:
//   $$HEX10$$80acc9c01cb4200038bb90c7f4c520002fac18c2$$ENDHEX$$
//
//REMARKS: 
//*************************************************/
...
public function boolean of_test (string as_teststr, string as_pattern);/************************************************
DESCRIPTION: $$HEX9$$28d334d144c7200055d678c769d5c8b2e4b2$$ENDHEX$$
...
public subroutine of_initialize (boolean ab_ignorecase, boolean ab_global);// Regular Expression $$HEX12$$1cc144bea4c27cb9200008cd30ae54d6200069d5c8b2e4b2$$ENDHEX$$
// ab_ignorecase : true=$$HEX10$$15c8dcadddc2200080acc9c02000dcc2200000b3$$ENDHEX$$/$$HEX13$$8cc138bb90c720006cad84bd44c7200034bbdcc269d5c8b2e4b2$$ENDHEX$$, false=$$HEX10$$15c8dcadddc2200080acc9c02000dcc2200000b3$$ENDHEX$$/$$HEX6$$8cc138bb90c720006cad84bd$$ENDHEX$$
// ab_global : true=$$HEX20$$15c8dcadddc2200080acc9c000b3c1c044c7200004c8b4cc200038bb90c7f4c55cb82000c0c915c8$$ENDHEX$$, false=$$HEX19$$15c8dcadddc2200080acc9c000b3c1c044c720005ccd08cd200080acc9c0d0c520005cd515c8$$ENDHEX$$
...
public subroutine of_initialize (boolean ab_ignorecase, boolean ab_global, string as_pattern);// Regular Expression $$HEX12$$1cc144bea4c27cb9200008cd30ae54d6200069d5c8b2e4b2$$ENDHEX$$
// ab_ignorecase : true=$$HEX10$$15c8dcadddc2200080acc9c02000dcc2200000b3$$ENDHEX$$/$$HEX13$$8cc138bb90c720006cad84bd44c7200034bbdcc269d5c8b2e4b2$$ENDHEX$$, false=$$HEX10$$15c8dcadddc2200080acc9c02000dcc2200000b3$$ENDHEX$$/$$HEX6$$8cc138bb90c720006cad84bd$$ENDHEX$$
// ab_global : true=$$HEX20$$15c8dcadddc2200080acc9c000b3c1c044c7200004c8b4cc200038bb90c7f4c55cb82000c0c915c8$$ENDHEX$$, false=$$HEX19$$15c8dcadddc2200080acc9c000b3c1c044c720005ccd08cd200080acc9c0d0c520005cd515c8$$ENDHEX$$
// as_pattern : $$HEX14$$38bb90c7f4c544c7200080acc9c060d5200015c8dcad5cd404d6ddc2$$ENDHEX$$
...
public function string of_getmatchstr (integer ai_index);if ai_index < 1 or ai_index > ii_matchcnt then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX20$$15c8dcadddc2200080acc9c0b0acfcac7cb92000200018b1b4c520c1200018c258ce85c7c8b2e4b2$$ENDHEX$$')
	return ''
end if
