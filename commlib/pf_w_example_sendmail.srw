HA$PBExportHeader$pf_w_example_sendmail.srw
forward
...
integer width = 4649
integer height = 2632
string title = "Mail $$HEX5$$04c8a1c1200008c61cc8$$ENDHEX$$"
cb_close cb_close
st_1 st_1
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "Mail $$HEX5$$04c8a1c1200008c61cc8$$ENDHEX$$"
boolean focusrectangle = false
end type
...
event pfe_postopen;call super::pfe_postopen;// Editor $$HEX6$$98d374c7c0c9200024c608d5$$ENDHEX$$
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX9$$b6252000f4bcb4b094b22000acc08cb72000$$ENDHEX$$: "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 22040656
string text = "BM$$HEX1$$00d3$$ENDHEX$$"
borderstyle borderstyle = stylelowered!
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX8$$b62520001bbc94b22000acc08cb72000$$ENDHEX$$... : "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX5$$b62520001cc8a9ba2000$$ENDHEX$$: "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 22040656
string text = "$$HEX10$$54ba7cc720004cd1a4c2b8d2200085c7c8b2e4b2$$ENDHEX$$"
borderstyle borderstyle = stylelowered!
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX5$$b6252000b4b0a9c62000$$ENDHEX$$: "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 22040656
string text = "$$HEX13$$4cd1a4c2b8d2200054ba7cc72000f8bc38bb200085c7c8b2e4b2$$ENDHEX$$."
...
fontfamily fontfamily = modern!
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
string text = "$$HEX2$$04c8a1c1$$ENDHEX$$"
end type
...
// $$HEX5$$0cd37cc72000a8cc80bd$$ENDHEX$$.
string ls_filename
...
if li_rc < 0 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX8$$54ba7cc7200004c8a1c12000e4c228d3$$ENDHEX$$~r~nRetCode=' + string(li_rc))
else
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX8$$54ba7cc7200004c8a1c1200031c1f5ac$$ENDHEX$$')
end if
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX7$$b62520000cd37cc7a8cc80bd2000$$ENDHEX$$: "
boolean focusrectangle = false
end type
