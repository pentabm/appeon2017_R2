HA$PBExportHeader$pf_w_printpreview.srw
$PBExportComments$$$HEX11$$9ccd25b82000f8bbacb9f4bc30ae200008c7c4b3b0c6$$ENDHEX$$
forward
...
integer width = 4027
integer height = 2816
string title = "$$HEX7$$9ccd25b82000f8bbacb9f4bc30ae$$ENDHEX$$"
boolean maxbox = true
...
public function integer of_setheadertextcolor ();// Header Band$$HEX25$$d0c52000f0d3b8d22000ecceecb700ac200070d7c9c078c720004dd1a4c2b8d200ac200074c8acc758d594b22000bdacb0c6$$ENDHEX$$
// $$HEX14$$74c77cb9200080ac40c7c9c03cc75cb82000c0bcbdacdcc2b4d02000$$ENDHEX$$--> $$HEX15$$54d674bad0c5200048c52000f4bc74c794b2200038bb1cc8200098ccacb9$$ENDHEX$$
...
public function integer of_setdatawindowcolumn ();// $$HEX15$$eccefcb72000adc01cc8a9c62000eccefcb7200015c8f4bc200024c115c8$$ENDHEX$$
...
event open;call super::open;datawindow	ldw_print
blob lb_data
...
string text = "$$HEX11$$9ccd25b86cd030ae2000a9c6c0c9d0c52000deb9a4cd$$ENDHEX$$"
end type
...
// $$HEX13$$f8bbacb9f4bc30ae3dccd0c520006cd030ae2000deb994cd30ae$$ENDHEX$$
//boolean lb_shrink
...
//// A4 $$HEX8$$acc074c788c95cb82000deb994cd30ae$$ENDHEX$$
//long ll_objcnt, i
...
integer taborder = 50
boolean bringtotop = true
string text = "$$HEX4$$eccefcb7adc01cc8$$ENDHEX$$"
end type
...
integer height = 88
integer taborder = 10
string text = "$$HEX4$$9ccd25b86cd030ae$$ENDHEX$$"
end type
...
integer height = 88
integer taborder = 20
string text = "$$HEX4$$f8bbacb9f4bc30ae$$ENDHEX$$"
end type
...
fontfamily fontfamily = modern!
string facename = "$$HEX3$$74adbcb9b4cc$$ENDHEX$$"
long textcolor = 33554432
long backcolor = 31439244
string text = "$$HEX4$$78c7c4c100c944be$$ENDHEX$$"
...
boolean enabled = false
string text = "$$HEX4$$9ccd25b829bca5d5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
long backcolor = 33090525
boolean enabled = false
string text = "$$HEX4$$9ccd25b8a9c6c0c9$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string text = "$$HEX2$$04c8b4cc$$ENDHEX$$"
end type
...
string item[] = {"Default","$$HEX2$$00ac5cb8$$ENDHEX$$","$$HEX2$$38c15cb8$$ENDHEX$$"}
...
string facename = "$$HEX2$$81ad1cc1$$ENDHEX$$"
long textcolor = 20724796
...
integer taborder = 20
boolean bringtotop = true
string text = "$$HEX2$$98cc4cc7$$ENDHEX$$"
end type
...
integer taborder = 30
boolean bringtotop = true
string text = "$$HEX2$$74c704c8$$ENDHEX$$"
end type
...
integer taborder = 40
boolean bringtotop = true
string text = "$$HEX2$$e4b24cc7$$ENDHEX$$"
end type
...
long textcolor = 33554432
long backcolor = 31439244
string text = "$$HEX9$$78c7c4c135c658c120000fbc200094bc04c7$$ENDHEX$$"
boolean focusrectangle = false
end type
...
long backcolor = 33090525
boolean enabled = false
string text = "$$HEX4$$78c7c4c194bc04c7$$ENDHEX$$"
boolean focusrectangle = false
end type
...
event buttonclicked;call super::buttonclicked;choose case dwo.name
	case 'b_delete'
		...
		if upperbound(ll_rows) = 0 then
			messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX11$$20c1ddd01cb4200089d574c72000c6c5b5c2c8b2e4b2$$ENDHEX$$.~r~n$$HEX19$$3cba00c820009ccd25b820001cc878c660d52000eccefcb744c7200020c1ddd058d538c194c6$$ENDHEX$$($$HEX8$$e4b211c9200020c1ddd0200000aca5b2$$ENDHEX$$)')
			return
		end if
