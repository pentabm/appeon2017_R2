HA$PBExportHeader$pf_w_example_etccontrols.srw
forward
...
global type pf_w_example_etccontrols from pf_w_sheet
string title = "$$HEX2$$30aec0d0$$ENDHEX$$UI $$HEX6$$d8c00cd5200008c7c4b3b0c6$$ENDHEX$$"
cb_close cb_close
st_2 st_2
st_1 st_1
st_3 st_3
...
this.Control[iCurrent+36]=this.ln_2
this.Control[iCurrent+37]=this.ln_3
end on
...
fontcharset fontcharset = hangeul!
long textcolor = 20066866
string text = " $$HEX8$$b625200074c7f8bbc0c9200094cd9ccd$$ENDHEX$$"
end type
...
fontcharset fontcharset = hangeul!
long textcolor = 20066866
string text = " $$HEX15$$b625200074d0bdb9f4bcdcb4200074c7f8bbc0c9200099bdecc523b130ae$$ENDHEX$$"
end type
...
string text = "$$HEX4$$99bdecc523b130ae$$ENDHEX$$"
end type
...
fontfamily fontfamily = modern!
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
string text = "$$HEX6$$74c7f8bbc0c9200094cd9ccd$$ENDHEX$$"
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX4$$edd098d374c7c0c9$$ENDHEX$$1"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX4$$edd098d374c7c0c9$$ENDHEX$$2"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX4$$edd098d374c7c0c9$$ENDHEX$$3"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX4$$edd098d374c7c0c9$$ENDHEX$$4"
boolean focusrectangle = false
end type
...
fontcharset fontcharset = hangeul!
long textcolor = 20066866
string text = " $$HEX2$$b6252000$$ENDHEX$$EditMask $$HEX1$$a9c6$$ENDHEX$$"
end type
...
fontcharset fontcharset = hangeul!
long textcolor = 20066866
string text = " $$HEX2$$b6252000$$ENDHEX$$Datawindow $$HEX1$$a9c6$$ENDHEX$$"
end type
...
event clicked;// $$HEX8$$c1c911c82000edd098d374c7c0c92000$$ENDHEX$$TEXT $$HEX2$$98ccacb9$$ENDHEX$$
tab_1.tabpage_2.text = '$$HEX8$$edd020004dd1a4c2b8d22000c0bcbdac$$ENDHEX$$'

// $$HEX8$$04ac11c82000edd098d374c7c0c92000$$ENDHEX$$TEXT $$HEX2$$98ccacb9$$ENDHEX$$
//uo_tab1.of_settabpagetext(2, '$$HEX8$$edd020004dd1a4c2b8d22000c0bcbdac$$ENDHEX$$')
...
event clicked;// $$HEX8$$c1c911c82000edd098d374c7c0c92000$$ENDHEX$$ENABLE $$HEX2$$98ccacb9$$ENDHEX$$
tab_1.tabpage_2.enabled = not tab_1.tabpage_2.enabled

// $$HEX8$$04ac11c82000edd098d374c7c0c92000$$ENDHEX$$ENABLE $$HEX2$$98ccacb9$$ENDHEX$$
...
event clicked;// $$HEX8$$c1c911c82000edd098d374c7c0c92000$$ENDHEX$$VISIBLE $$HEX2$$98ccacb9$$ENDHEX$$
tab_1.tabpage_2.visible = not tab_1.tabpage_2.visible

// $$HEX8$$04ac11c82000edd098d374c7c0c92000$$ENDHEX$$VISIBLE $$HEX2$$98ccacb9$$ENDHEX$$
...

