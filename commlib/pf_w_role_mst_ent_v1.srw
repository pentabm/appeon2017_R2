HA$PBExportHeader$pf_w_role_mst_ent_v1.srw
...
for i = 1 to ids_role_cat.rowcount()
	...
	elseif not pf_f_isemptystring(ls_code_list_sql) then
		...
		messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX24$$8cad5cd5200020c715d615c8f4bc00ac20002cc614bc74b98cac200024c115c818b4c0c920004ac558c5b5c2c8b2e4b2$$ENDHEX$$')
		return -1
	end if
...
public subroutine of_set_status_tvi_checkbox (treeviewitem atvi_item, boolean ab_switch);// $$HEX26$$b8d2acb9f0bd200044c574c75cd158c72000b4cc6cd015bca4c2200020c1ddd02000ecc580bd200024c115c8200069d5c8b2e4b2$$ENDHEX$$.
...
public function boolean of_get_status_tvi_checkbox (treeviewitem atvi_item);// $$HEX27$$b8d2acb9f0bd200044c574c75cd158c72000b4cc6cd015bca4c2200020c1ddd02000ecc580bd7cb92000acb934d1200069d5c8b2e4b2$$ENDHEX$$.
...
ll_row = dw_role_mst.getrow()
if ll_row = 0 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX15$$04d6acc7200020c1ddd01cb420008cad5cd574c72000c6c5b5c2c8b2e4b2$$ENDHEX$$')
	return
end if

ls_role_no = dw_role_mst.getitemstring(ll_row, 'role_no')

// $$HEX17$$c1c004c72000f4d354b3200020c1ddd0200048c51cb42000bdacb0c62000b4cc6cd0$$ENDHEX$$
...
// $$HEX13$$c0bcbdac2000acc06dd5d0c5200000b374d51cc1200085c725b8$$ENDHEX$$, $$HEX10$$adc01cc860d5200044c574c75cd120006cad84bd$$ENDHEX$$
...
// $$HEX9$$8cad5cd5200070b374c730d1200000c8a5c7$$ENDHEX$$
if dw_role_memb.update(true, false) = 1 then
	if ids_role_pgm.update(true, false) = 1 then
		...
		of_setmessage('$$HEX11$$8cad5cd5200024c115c8200000c8a5c7200044c6ccb8$$ENDHEX$$!!')
		
		// $$HEX4$$adc01cc81cb42000$$ENDHEX$$ROW $$HEX3$$acc770c88cd6$$ENDHEX$$
		ids_role_pgm.retrieve(gnv_session.is_sys_id, is_current_role_no)
	else
		ls_errtext = sqlca.sqlerrtext
		rollback using sqlca;
		messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX11$$8cad5cd5200024c115c8200000c8a5c72000e4c228d3$$ENDHEX$$!!~r~n' + 'Error Text: ' + ls_errtext)
	end if
else
	ls_errtext = sqlca.sqlerrtext
	rollback using sqlca;
