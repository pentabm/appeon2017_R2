HA$PBExportHeader$pf_w_example_fileupdownload.srw
forward
...
global type pf_w_example_fileupdownload from pf_w_sheet
string title = "$$HEX4$$0cd37cc72000c5c5$$ENDHEX$$/$$HEX11$$e4b2b4c65cb8dcb42000d8c00cd5200008c7c4b3b0c6$$ENDHEX$$"
cb_close cb_close
cb_1 cb_1
st_1 st_1
...
if pf_f_isemptystring(ls_serverurl) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX3$$1cc184bc2000$$ENDHEX$$URL $$HEX9$$15c8f4bc7cb9200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(ls_subdir) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX4$$c5c55cb8dcb42000$$ENDHEX$$SUbDirectory $$HEX9$$15c8f4bc7cb9200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(ls_filename) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX14$$c5c55cb8dcb460d520000cd37cc744c7200020c1ddd058d538c194c6$$ENDHEX$$')
	return
end if
...
if li_rc < 0 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX6$$c5c55cb8dcb42000e4c228d3$$ENDHEX$$~r~nRetCode=' + string(li_rc))
else
...
string text = "$$HEX2$$b6252000$$ENDHEX$$Server URL : "
...
string text = "http://localhost:8080/pfservices/FileUpload"
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX2$$b6252000$$ENDHEX$$Sub Directory : "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX2$$b6252000$$ENDHEX$$Filename to be uploaded : "
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "HTTP $$HEX6$$0cd37cc72000c5c55cb8dcb4$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "HTTP $$HEX7$$0cd37cc72000e4b2b4c65cb8dcb4$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 22040656
string text = "http://localhost:8080/pfservices/FileDownload"
borderstyle borderstyle = stylelowered!
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX2$$b6252000$$ENDHEX$$Filename to be downloaded"
boolean focusrectangle = false
end type
...
if pf_f_isemptystring(ls_serverurl) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX8$$e4b2b4c65cb8dcb420001cc184bc2000$$ENDHEX$$URL $$HEX9$$15c8f4bc7cb9200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(ls_subdir) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX5$$e4b2b4c65cb8dcb42000$$ENDHEX$$SUbDirectory $$HEX9$$15c8f4bc7cb9200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(ls_filename) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX16$$e4b2b4c65cb8dcb460d520000cd37cc785ba44c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
if li_rc < 0 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX7$$e4b2b4c65cb8dcb42000e4c228d3$$ENDHEX$$~r~nRetCode=' + string(li_rc))
end if
