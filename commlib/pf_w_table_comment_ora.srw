HA$PBExportHeader$pf_w_table_comment_ora.srw
$PBExportComments$$$HEX11$$70b374c730d1a0bc74c7a4c220004cd174c714be2000$$ENDHEX$$Commnet $$HEX2$$00adacb9$$ENDHEX$$
forward
...
do while ll_row > 0
	...
	if sqlca.sqlcode <> 0 then
		messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX18$$44c598b740c6200019ac40c7200024c658b900ac20001cbcddc058d500c6b5c2c8b2e4b2$$ENDHEX$$~r~n' + sqlca.sqlerrtext)
		return
	end if
