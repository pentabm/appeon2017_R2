HA$PBExportHeader$pf_w_database_info_ora.srw
$PBExportComments$$$HEX12$$70b374c730d1a0bc74c7a4c2200015c8f4bc200070c88cd6$$ENDHEX$$
forward
...
event open;call super::open;// Oracle$$HEX27$$d0c520000cd3ccc604d508b884c720004cd174c714be200094cd00ac58d530ae200004c84caec0c9200084c7dcc25cb82000acc0a9c6$$ENDHEX$$
...
if itr_ora.sqlcode <> 0 then 
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'DATABASER $$HEX5$$f0c5b0ac2000e4c228d3$$ENDHEX$$!!~r~n' + itr_ora.sqlerrtext)
	return
end if

// Scintilla Editor $$HEX3$$08cd30ae54d6$$ENDHEX$$
string ls_FaceName
...
// source $$HEX4$$70c88cd6a9c62000$$ENDHEX$$datastore
...
event rowfocuschanged;call super::rowfocuschanged;// $$HEX15$$24c60cbe1dc8b8d22000c0d085c7c4bc5cb82000b4b0a9c6200070c88cd6$$ENDHEX$$
...
if ll_row > 0 then
	...
	if messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX5$$20c1ddd058d5e0c22000$$ENDHEX$$' + ls_docu_title + '[' + ls_docu_no + '] $$HEX13$$8cacdcc23cbb44c72000adc01cc858d5dcc2a0acb5c2c8b24cae$$ENDHEX$$?', Exclamation!, YesNo!, 2) = 1 then
...
of_setmessage('[' + string(ll_rowcnt, '#,##0') + ']$$HEX14$$74ac58c7200090c7ccb800ac200070c88cd618b4c8c5b5c2c8b2e4b2$$ENDHEX$$')
