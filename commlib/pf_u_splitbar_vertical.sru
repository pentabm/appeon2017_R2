HA$PBExportHeader$pf_u_splitbar_vertical.sru
$PBExportComments$$$HEX7$$0cd3ccc604d508b884c7a9c62000$$ENDHEX$$Vertical Splitbar $$HEX7$$e8ceb8d264b8200085c7c8b2e4b2$$ENDHEX$$.
forward
...
FOR li_cnt = 1 TO li_max
	// $$HEX17$$44c598b72000e8ceb8d264b8e4b440c72000acb9acc074c788c9200048c5200068d5$$ENDHEX$$
	...
	// $$HEX9$$7cc6bdca2000ecc531bc200094cd00ac2000$$ENDHEX$$2015.4.28
...
FOR li_cnt = 1 TO li_max
	...
	// $$HEX10$$24c678b9bdca2000ecc531bc200094cd00ac2000$$ENDHEX$$2015.4.28
...
public function integer of_setobjectsbyname (string as_direction, string as_objectnames);// LEFT, RIGHT $$HEX21$$24c60cbe1dc8b8d27cb9200024c60cbe1dc8b8d2200074c784b93cc75cb82000f1b45db869d5c8b2e4b2$$ENDHEX$$
// as_direction: left = $$HEX6$$7cc6bdca24c60cbe1dc8b8d2$$ENDHEX$$, right=$$HEX11$$24c678b9bdca200024c60cbe1dc8b8d22000f1b45db8$$ENDHEX$$
// as_objectnames = $$HEX10$$f1b45db860d5200024c60cbe1dc8b8d2200085ba$$ENDHEX$$($$HEX8$$ecc5ecb71cac78c72000bdacb0c62000$$ENDHEX$$; $$HEX4$$5cb820006cad84bd$$ENDHEX$$)
...
for i = 1 to li_objcnt
	...
	if not isvalid(lwo_control) then
		messagebox('[' + this.classname() + '] $$HEX2$$4cc5bcb9$$ENDHEX$$', '[' + ls_object[i] + '] $$HEX16$$24c60cbe1dc8b8d285ba44c720003ecc44c7200018c22000c6c5b5c2c8b2e4b2$$ENDHEX$$')
		return -1
	end if
