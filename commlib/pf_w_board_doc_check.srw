HA$PBExportHeader$pf_w_board_doc_check.srw
$PBExportComments$$$HEX21$$8cacdcc23cbb200070c88cd62000b4b0edc5200055d678c7200004d55cb8f8ada8b7200085c7c8b2e4b2$$ENDHEX$$.
forward
...
string text = "$$HEX8$$f5acc0c9acc06dd52000acb9a4c2b8d2$$ENDHEX$$"
...
// $$HEX11$$f5acc0c9acc06dd52000f4c58cb790c7200070c88cd6$$ENDHEX$$
...
// $$HEX13$$f5acc0c9acc06dd52000f8bb2000f4c58cb790c7200070c88cd6$$ENDHEX$$
...
// $$HEX15$$04c8b4cc200070c88cd678c72000bdacb0c62000fccfacb92000ddc031c1$$ENDHEX$$
...
// $$HEX15$$80bd84bd200070c88cd678c72000bdacb0c62000fccfacb92000ddc031c1$$ENDHEX$$
else
...
choose case string(dwo.name)
	case 'board_no'
		...
		if ids_board_mst.retrieve(gnv_session.is_sys_id, is_board_no) > 0 then
			...
			if ls_log_yn <> 'Y' then
				messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX8$$20c1ddd058d5e0c220008cacdcc210d3$$ENDHEX$$(Board)$$HEX32$$40c720005cb8f8adddc031c144c7200058d5c0c94ac530ae20004cb538bbd0c5200070c88cd690c77cb9200055d678c760d5200018c22000c6c5b5c2c8b2e4b2$$ENDHEX$$')
				return
			end if
		end if
end choose
...
long textcolor = 25123896
long backcolor = 16777215
string text = "$$HEX9$$f5acc0c9acc06dd5200070c88cd6b4b0edc5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
integer width = 2866
integer height = 1652
string text = "$$HEX3$$f4c58cb790c7$$ENDHEX$$"
...
integer width = 2866
integer height = 1652
string text = "$$HEX4$$f8bbf4c58cb790c7$$ENDHEX$$"
long tabtextcolor = 20132659
long tabbackcolor = 1073741824
