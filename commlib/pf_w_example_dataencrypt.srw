HA$PBExportHeader$pf_w_example_dataencrypt.srw
forward
...
global type pf_w_example_dataencrypt from pf_w_sheet
string title = "$$HEX14$$70b374c730d1200054c538d654d62000d8c00cd5200008c7c4b3b0c6$$ENDHEX$$"
cb_close cb_close
ddlb_1 ddlb_1
st_1 st_1
st_2 st_2
...
string text = "$$HEX3$$54c538d654d6$$ENDHEX$$/$$HEX3$$f5bc38d654d6$$ENDHEX$$"
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "HASH $$HEX2$$98ccacb9$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX8$$54c538d654d660d5200038bb90c7f4c5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX8$$54c538d654d61cb4200038bb90c7f4c5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
fontfamily fontfamily = modern!
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
string text = "$$HEX3$$54c538d654d6$$ENDHEX$$"
end type

event clicked;if pf_f_isemptystring(sle_plain.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX15$$54c538d654d660d5200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(sle_secretkey.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX22$$54c538d654d62000dcc22000acc0a9c620b42000a4d0200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
choose case ddlb_1.text
	...
	case else
		messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX15$$54c538d654d620004cc5e0acacb998c944c7200020c1ddd058d538c194c6$$ENDHEX$$')
end choose
...
fontfamily fontfamily = modern!
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
string text = "$$HEX3$$f5bc38d654d6$$ENDHEX$$"
end type

event clicked;if pf_f_isemptystring(sle_encrypted.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX14$$f5bc38d654d660d5200038bb90c7f4c574c72000c6c5b5c2c8b2e4b2$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(sle_secretkey.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX22$$f5bc38d654d62000dcc22000acc0a9c620b42000a4d0200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
messagebox('$$HEX8$$f5bc38d654d61cb4200038bb90c7f4c5$$ENDHEX$$', ls_plaintext)
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX5$$54c538d654d62000a4d0$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX8$$54c538d654d620004cc5e0acacb998c9$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "Hash$$HEX8$$98ccacb9200060d5200038bb90c7f4c5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "Hash $$HEX7$$98ccacb91cb4200038bb90c7f4c5$$ENDHEX$$"
boolean focusrectangle = false
end type
...
event clicked;if pf_f_isemptystring(sle_plain2.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'Hash $$HEX15$$98ccacb9200060d5200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
event clicked;if pf_f_isemptystring(sle_base64_encode.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'BASE64 $$HEX15$$54c538d654d660d5200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
event clicked;if pf_f_isemptystring(sle_base64_decode.text) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'BASE64 $$HEX16$$f5bc38d654d6200060d5200038bb90c7f4c544c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
