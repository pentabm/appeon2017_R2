HA$PBExportHeader$pf_w_favorite_rename.srw
$PBExportComments$$$HEX24$$acc0a9c690c7c4bc200090c9a8ac3ecc30ae7cb9200074c784b92000c0bcbdac58d594b2200054d674ba85c7c8b2e4b2$$ENDHEX$$
forward
global type pf_w_favorite_rename from pf_w_response
end type
type cb_new from pf_u_commandbutton within pf_w_favorite_rename
end type
type dw_favor from pf_u_datawindow within pf_w_favorite_rename
end type
type p_cancel from pf_u_imagebutton within pf_w_favorite_rename
end type
type p_ok from pf_u_imagebutton within pf_w_favorite_rename
end type
type st_2 from pf_u_statictext within pf_w_favorite_rename
end type
type st_1 from pf_u_statictext within pf_w_favorite_rename
end type
type st_title from pf_u_statictext within pf_w_favorite_rename
end type
type p_icon from pf_u_picture within pf_w_favorite_rename
end type
end forward
...
integer width = 2213
integer height = 964
string title = "$$HEX11$$90c9a8ac3ecc30ae200074c784b9200014bcb8af30ae$$ENDHEX$$"
cb_new cb_new
dw_favor dw_favor
p_cancel p_cancel
p_ok p_ok
...
global pf_w_favorite_rename pf_w_favorite_rename
...
on pf_w_favorite_rename.create
int iCurrent
call super::create
...
on pf_w_favorite_rename.destroy
call super::destroy
destroy(this.cb_new)
...
event open;call super::open;long	ll_rowcnt
...
ll_rowcnt = dw_favor.Retrieve(gnv_session.is_sys_id, gnv_session.is_user_id, inv_menuparm.is_menu_id)
...
type ln_templeft from pf_w_response`ln_templeft within pf_w_favorite_rename
end type

type ln_tempright from pf_w_response`ln_tempright within pf_w_favorite_rename
end type

type ln_temptop from pf_w_response`ln_temptop within pf_w_favorite_rename
end type

type ln_tempbuttom from pf_w_response`ln_tempbuttom within pf_w_favorite_rename
end type

type ln_tempbutton from pf_w_response`ln_tempbutton within pf_w_favorite_rename
end type

type ln_tempstart from pf_w_response`ln_tempstart within pf_w_favorite_rename
end type
...
integer height = 276
integer taborder = 10
string dataobject = "pf_d_favorite_rename"
...
string ls_parent_menu, ls_menu_id, ls_before_parent_menu
...
if ll_cnter < 1 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', "$$HEX27$$74d5f9b2200004d55cb8f8ada8b740c7200090c9a8ac3ecc30ae5cb82000f1b45db818b4b4c5200088c7c0c920004ac5b5c2c8b2e4b2$$ENDHEX$$.")
	closewithreturn(parent, 'Cancel')
	return
end if

//$$HEX18$$90c9a8ac3ecc30ae2000f4d354b32000c0bcbdac2000dcc2d0c5ccb920001cc288bc2000$$ENDHEX$$Update
ls_before_parent_menu = dw_favor.GetItemString(1, 'parent_menu', Primary!, True)

if ls_before_parent_menu <> ls_parent_menu then
...
if dw_favor.update() = 1 then
	commit using sqlca;
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', '$$HEX10$$90c9a8ac3ecc30ae2000c0bcbdac200044c6ccb8$$ENDHEX$$')
else
	rollback using sqlca;
...
//			return
//		case else
			messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', "$$HEX10$$90c9a8ac3ecc30ae2000c0bcbdac2000e4c228d3$$ENDHEX$$![" + string(dw_favor.istr_dberror.sqldbcode) + "]~r~n" + dw_favor.istr_dberror.sqlerrtext)	
			closewithreturn(parent, 'Cancel')
			return
//	end choose
end if
...
string text = "$$HEX17$$c0bcbdac60d5200074c784b9fcac200004c758ce7cb9200085c725b858d538c194c6$$ENDHEX$$."
end type
...
integer width = 1723
long textcolor = 20132659
string text = "$$HEX26$$74c7200090c9a8ac3ecc30ae58c7200074c784b9fcac200004c758ce7cb92000c0bcbdac60d5200018c2200088c7b5c2c8b2e4b2$$ENDHEX$$."
end type
...
string text = "$$HEX11$$90c9a8ac3ecc30ae200074c784b9200014bcb8af30ae$$ENDHEX$$"
end type
