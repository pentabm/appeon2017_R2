HA$PBExportHeader$pf_w_example_hashtable.srw
forward
...
global type pf_w_example_hashtable from pf_w_sheet
string title = "$$HEX12$$74d5dcc24cd174c714be2000d8c00cd5200008c7c4b3b0c6$$ENDHEX$$"
cb_close cb_close
st_4 st_4
st_1 st_1
...
string facename = "$$HEX5$$d1b940c72000e0ac15b5$$ENDHEX$$"
long textcolor = 20066866
string text = "$$HEX2$$b6252000$$ENDHEX$$HashTable Key List"
boolean focusrectangle = false
end type
...
if pf_f_isemptystring(ls_key) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'Key $$HEX9$$6dd5a9ba44c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if

if pf_f_isemptystring(ls_value) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'Value $$HEX9$$6dd5a9ba44c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
if pf_f_isemptystring(ls_key) then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'Hash$$HEX24$$4cd174c714bed0c51cc1200012ac44c7200000ac38c82cc62000a4d020006dd5a9ba44c7200085c725b858d538c194c6$$ENDHEX$$')
	return
end if
...
if ll_row = 0 then
	messagebox('$$HEX2$$4cc5bcb9$$ENDHEX$$', 'Remove $$HEX4$$98ccacb960d52000$$ENDHEX$$KeyName $$HEX7$$44c7200020c1ddd058d538c194c6$$ENDHEX$$')
	return
end if
