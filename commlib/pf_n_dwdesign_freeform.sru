HA$PBExportHeader$pf_n_dwdesign_freeform.sru
$PBExportComments$Freeform $$HEX19$$a4c2c0d07cc7200070b374c730d108c7c4b3b0c6200014b590c778c7200098ccacb9a9c62000$$ENDHEX$$NVO $$HEX3$$85c7c8b2e4b2$$ENDHEX$$.
forward
...
// create temporary object to highlight get focused column
lnv_newsyntax.of_append('text(band=header alignment="2" text="" border="0" color="33554432" x="0" y="0" height="76" width="100" html.valueishtml="0" name=pf_getfocusedcolumn_t visible="0" font.face="Tahoma" font.height="-9" font.weight="400" font.family="2" font.pitch="1" font.charset="129" background.mode="1" background.color="536870912" )')
				...
				if EditableColumnBorder then
					if ls_editstyle <> 'checkbox' and ls_editstyle <> 'radiobuttons' then
						if ll_cellheight > ll_height + pixelstounits(2, ypixelstounits!) then
							...
							// PB10 $$HEX5$$84c7dcc2200098ccacb9$$ENDHEX$$
							ls_visible = '0'
...
// Resize$$HEX2$$dcc22000$$ENDHEX$$Freeform datawindow$$HEX2$$94b22000$$ENDHEX$$Height$$HEX13$$7cb9200070b374c730d108c7c4b3b0c640c62000deb9b0cd1cc1$$ENDHEX$$
// Click$$HEX2$$dcc22000$$ENDHEX$$Runtime $$HEX9$$24c658b97cb9200029bcc0c95cd5e4b22000$$ENDHEX$$(Detail $$HEX9$$94bc04c77cb9200097bcb4c598b074ba2000$$ENDHEX$$Row = 0$$HEX3$$74c7200028b4$$ENDHEX$$)
