HA$PBExportHeader$pf_u_webeditor.sru
forward
...
public subroutine of_openwebeditor ();// SmartEditor $$HEX6$$98d374c7c0c9200024c608d5$$ENDHEX$$
...
public subroutine of_openwebeditor (string as_contents);// SmartEditor Editor $$HEX6$$98d374c7c0c9200024c608d5$$ENDHEX$$
this.of_navigate(EDITOR_URL)

// HTML $$HEX6$$e8ce50d120ce200094cd00ac$$ENDHEX$$
this.of_execscript("setInitContents('" + as_contents + "');")

end subroutine

public subroutine of_openwebviewer ();// SmartEditor Viewer $$HEX6$$98d374c7c0c9200024c608d5$$ENDHEX$$
this.of_navigate(VIEWER_URL)

end subroutine

public subroutine of_openwebviewer (string as_contents);// SmartEditor Viewer $$HEX6$$98d374c7c0c9200024c608d5$$ENDHEX$$
this.of_navigate(VIEWER_URL)
...
event constructor;call super::constructor;// $$HEX5$$f9c6d0c514b530d12000$$ENDHEX$$URL $$HEX2$$24c115c8$$ENDHEX$$
